...
class LSTMModel:
  ...
  def __init__(self, dir, model_name, mode = 'new', N_PERIOD = 1, timestep = 10, number_of_days_pred = 20): #number of actual prediction is number_of_days_pred - timestep
    self.targets = ['close']
...
# LSTM_obj1 = LSTMModel('../btc_metrics_raw.csv','../models/saved_models/btc/lstm_price_predictor.hp5', 'load')
# prediction = LSTM_obj1.forecast()
# prediction = LSTM_obj1.past_seven_days_forecast().reset_index().rename(columns={0: 'LSTM'}) 
# print(prediction)
